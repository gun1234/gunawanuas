...
*/
$config['tables']['users']           = 'frm_users';
$config['tables']['groups']          = 'frm_groups';
$config['tables']['users_groups']    = 'frm_users_groups';
$config['tables']['login_attempts']  = 'frm_login_attempts';
