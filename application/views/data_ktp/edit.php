	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="row">
				...
				<?php echo form_open_multipart('data_ktp/edit/'.$row->id); ?>
				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="informasi-pribadi">
						...
						<div class="form-group">
							...
							<div class="form-input">
								<input type="number" name="nik" value="<?php echo $row->nik; ?>" class="form-control input-50" id="nik" required="required"/>
						...
						<div class="form-group">
							...
							<div class="form-input">
								<input type="text" name="nama" value="<?php echo $row->nama; ?>" class="form-control input-50" id="nama" required="required"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="form-input">
								<input type="text" name="tempat_lahir" value="<?php echo $row->tempat_lahir; ?>" class="form-control input-50" id="tempat_lahir" required="required"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="form-input input-group input-50">
								<input type="text" class="form-control datepicker" aria-label="Tanggal lahir" name="tanggal_lahir" value="<?php echo waktu($row->tanggal_lahir); ?>" required="required">
						...
						<div class="form-group">
							...
							<div class="form-input">
								<input type="text" name="agama" value="<?php echo $row->agama; ?>" class="form-control input-50" id="agama"  required="required"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="form-input">
								<input type="text" name="pekerjaan" value="<?php echo $row->pekerjaan; ?>" class="form-control input-50" id="pekerjaan" required="required"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="form-input input-group input-50">
								<input type="text" class="form-control datepicker" aria-label="Berlaku hingga" name="berlaku_hingga" value="<?php echo waktu($row->berlaku_hingga); ?>" required="required">
								<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
							</div>							
						</div>
						...
						<div class="form-group">
							...
							<div class="form-input">
								<input type="email" name="email" value="<?php echo $row->email; ?>" class="form-control input-50" id="email" required="required" />
					...
					<div class="tab-pane" id="alamat">
						...
						<div class="form-group">
							...
							<div class="form-input">
								<textarea name="alamat" class="form-control input-50" id="alamat"><?php echo $row->alamat; ?></textarea>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<div class="form-input">
										<input type="text" name="rt" value="<?php echo $row->rt; ?>" class="form-control" id="rt" />
									</div>
								</div>
							</div>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<div class="form-input">
										<input type="text" name="rw" value="<?php echo $row->rw; ?>" class="form-control" id="rw" />
									</div>
								</div>
							</div>
						...
						<div class="form-group">
							...
							<div class="form-input">
								<input type="text" name="wilayah" value="<?php echo $row->wilayah; ?>" class="form-control input-50" id="wilayah" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="form-input">
								<input type="text" name="kelurahan" value="<?php echo $row->kelurahan; ?>" class="form-control input-50" id="kelurahan" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="form-input">
								<input type="text" name="kecamatan" value="<?php echo $row->kecamatan; ?>" class="form-control input-50" id="kecamatan" />
							</div>
						</div>			
					</div><!-- end alamat -->
					...
					<div class="tab-pane" id="sosial-media">
						...
						<div class="form-group">
							...
							<div class="form-input">
								<input type="text" name="twitter" value="<?php echo $row->twitter; ?>" class="form-control input-50" id="twitter" placeholder="@namakamu"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="form-input">
								<input type="text" name="facebook" value="<?php echo $row->facebook; ?>" class="form-control input-50" id="facebook" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="form-input">
								<input type="text" name="instagram" value="<?php echo $row->instagram; ?>" class="form-control input-50" id="instagram" />
						...
						<div class="form-group">
							...
							<div class="form-input">
								<input type="text" name="path" value="<?php echo $row->path; ?>" class="form-control input-50" id="path" />
							</div>
						</div>
