        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <div class="box-body pad">
              <form role="form" action="<?php echo base_url('index.php/admin/post/aksi_add'); ?>" enctype="multipart/form-data" method="post">
                <div class="box-body">
                  <div class="form-group">
                    <label for="title">Judul article</label>
                    <input type="text" class="form-control" required="required" name="title" id="title" placeholder="Masukan Judul">
                  </div>
                  <div class="form-group">
                    <label for="html_content">Header article</label>
                    <input type="text" class="form-control" required="required" name="html_content" id="html_content" placeholder="Masukan header text">
                  </div>
                  <div class="form-group">
                  ...
                  <textarea required="required" pattern="[A-Za-z0-9]{1,20}" name="markdown_content" class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
